...
/// @title ImmortalDemons
/// @notice This contract handles the token management and battle logic for the ImmortalDemons game
...
contract ImmortalDemons is ERC1155, Ownable, ERC1155Supply {
    ...
    uint256 public constant ISTASHA = 5;
